...
export default function ResetPassword() {
  const trustChips = ["Secure Reset", "Encrypted Password", "Session Protected", "Audit Logged"];
  const resetNotes = ["Set a strong password", "Secure your workspace access", "Return to governed AI workflows"];
